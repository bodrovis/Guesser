...
module Guesser
  ...
  class Game
    ...
    def initialize
      ...
      puts "After players guesses a number, a new one will be generated. The first one to guess #{POINTS_TO_GO}
      ...
      until @winner do
        @players.each do |player|
          ...
          player.waiting_times << measure_time {
            player.guess == player.number_to_guess.secret_number ? player.guessed : puts("Try again next turn!")
          }
